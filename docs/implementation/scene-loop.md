...
- high scene に 5 cut 以上、critical scene に 7 cut 以上の pressure / reaction / handoff 設計がない。
...
- high scene は 5 cut 以上、critical scene は 7 cut 以上を目安にする。
- `target_duration_seconds / 8` を切り上げた cut 数を下回ってはいけない。
