...
画像生成の正解は、**「うまい一文を書く」ことではなく、構造化して anchor を決め、reference を固定し、prompt collection をレビューしてから回すこと**である。
...
**構造化する → anchor を決める → reference を固定する → prompt 集をレビューする → 画像生成する** である。
