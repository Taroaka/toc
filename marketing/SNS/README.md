...
- 副業または個人ブランドの専用 LP へ送る
- 完成物だけでなく、入力、制作過程、所要時間、人間の判断を見せる

## Primary personas

| Persona | 最初に動かす感情 | 見せる変化 | CTA |
|---------|------------------|------------|-----|
| 副業を始めたい個人 | 停滞から解放、自己効力感 | 限られた時間でも最初の1本を完成できる | 副業の最初の1本を作る |
| 個人ブランドを構築したい個人 | 可能性、誇り、継続への確信 | 知識や世界観を一貫した動画資産へ変える | 自分のブランド動画を設計する |
...
- ツール操作ではなく、動画を完成させる流れ

### 3. Persona outcomes

- 本業後でも最初の1本を試せる
- 一つの専門テーマから series を作れる
- 発信を止めずに動画資産を蓄積できる
- 作った動画から反応を得て次を改善できる
...
- 1投稿は1 persona、1 obstacle、1 proof、1 CTA
- `稼げる` を保証せず、低い制作負担で検証回数を増やせる価値を伝える
- brand persona には速さだけでなく一貫性と人間の判断を見せる
