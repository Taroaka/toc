    ...
    return "\n".join(
        [
            ...
            *(source_lines or ["- `(none discovered)`"]),
            ...
            "A scene_composite passes only when scene_cut_coverage_plan.scene_obligations are assigned to cut_entries, the cut prompts collectively visualize the scene's intended question/value shift/causal turn/handoff, and the planned videos can connect into one meaningful scene.",
