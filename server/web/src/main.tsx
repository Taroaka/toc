...
function assetPromptFromDesign(ref: ReferenceOption): string {
  if (ref.path.startsWith('assets/characters/')) {
    return [
      ...
      'フォトリアルな実写映画風。現実の人物、現実の布、自然な肌、物理的なレンズと照明、実物セット感を優先する。アニメ、漫画、イラスト、絵本、コンセプトアート、3D cartoon、plastic CGI、ゲームCG、ドール顔は禁止。文字なし、ロゴなし、ウォーターマークなし。',
      '',
      `[対象]`,
  ...
  if (ref.path.startsWith('assets/objects/')) {
    return [
      ...
      'フォトリアルな実写映画風。現実の素材、自然な反射、物理的なレンズと照明、実物セット感を優先する。アニメ、漫画、イラスト、絵本、コンセプトアート、3D cartoon、plastic CGI、ゲームCGは禁止。文字なし、ロゴなし、ウォーターマークなし。',
      '',
      '[対象]',
      `${ref.label} のアイテム参照画像。`,
      '',
  ...
  return [
    ...
    'フォトリアルな実写映画風。現実の建築・自然な光・物理的なレンズと照明・実物セット感を優先する。アニメ、漫画、イラスト、絵本、コンセプトアート、3D cartoon、plastic CGI、ゲームCGは禁止。文字なし、ロゴなし、ウォーターマークなし。人物を出さない。',
    '',
    '[対象]',
    `${ref.label} の場所参照画像。`,
    '',
