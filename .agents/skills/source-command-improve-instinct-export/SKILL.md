---
name: "source-command-improve-instinct-export"
description: "Export instincts for sharing with teammates or other projects"
---

# source-command-improve-instinct-export

Use this skill when the user asks to run the migrated source command `improve-instinct-export`.
