---
name: "source-command-improve-go-build"
description: "Fix Go build errors, go vet warnings, and linter issues incrementally. Invokes the go-build-resolver agent for minimal, surgical fixes."
---

# source-command-improve-go-build

Use this skill when the user asks to run the migrated source command `improve-go-build`.
