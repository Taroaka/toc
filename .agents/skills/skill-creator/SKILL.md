---
name: skill-creator
description: 汎用的な作業パターンを発見した際に、再利用可能なCodexスキルを自動生成する。繰り返し使えるワークフロー、ベストプラクティス、ドメイン知識をスキル化する時に使用。
---
...
作業中に発見した汎用的なパターンを、再利用可能なCodexスキルとして保存する。
...
5. 保存
   - パス: ~/.Codex/skills/shogun-{skill-name}/
   - 既存スキルと名前が被らないか確認
