...
description: Consult official Codex documentation from docs.Codex.com using selective fetching. Use this skill when working on Codex hooks, skills, subagents, MCP servers, or any Codex feature that requires referencing official documentation for accurate implementation. Fetches only the specific documentation needed rather than loading all docs upfront.
---
...
This skill enables efficient consultation of official Codex documentation by fetching only the specific docs needed for the current task. Instead of loading all documentation upfront, determine which docs are relevant and fetch them on-demand.

## When to Use This Skill

Invoke this skill when:

- Creating or modifying Codex hooks
...
- Understanding any Codex feature that requires official documentation
- Troubleshooting Codex functionality
...
- **hooks-guide.md** - Comprehensive guide to creating hooks with examples and best practices
  ...
  - URL: `https://code.Codex.com/docs/en/hooks-guide.md`
...
- **hooks.md** - Hooks API reference with event types and parameters
  - URL: `https://code.Codex.com/docs/en/hooks.md`
...
- **skills.md** - Skills creation guide and structure reference
  - URL: `https://code.Codex.com/docs/en/skills.md`
...
- **sub-agents.md** - Subagent types, parameters, and usage
  - URL: `https://code.Codex.com/docs/en/sub-agents.md`
...
- **Other Codex feature** → Proceed to Step 2
...
```
URL: https://code.Codex.com/docs/en/claude_code_docs_map.md
```

The docs map lists all available Codex documentation with descriptions. Identify the relevant doc(s) from the map.
...
```
WebFetch:
  url: https://code.Codex.com/docs/en/[doc-name].md
...
**User request:** "How do I configure Codex settings.json?"
...
4. Fetch specific doc: `https://code.Codex.com/docs/en/settings.md`
...
- Always fetch from docs.Codex.com (live docs, not cached copies)
