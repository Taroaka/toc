---
name: "source-command-improve-skill-create"
description: "Analyze local git history to extract coding patterns and generate SKILL.md files. Local version of the Skill Creator GitHub App."
---

# source-command-improve-skill-create

Use this skill when the user asks to run the migrated source command `improve-skill-create`.
