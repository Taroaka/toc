---
name: "source-command-improve-instinct-import"
description: "Import instincts from teammates, Skill Creator, or other sources"
---

# source-command-improve-instinct-import

Use this skill when the user asks to run the migrated source command `improve-instinct-import`.
