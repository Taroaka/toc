---
name: "source-command-improve-go-review"
description: "Comprehensive Go code review for idiomatic patterns, concurrency safety, error handling, and security. Invokes the go-reviewer agent."
---

# source-command-improve-go-review

Use this skill when the user asks to run the migrated source command `improve-go-review`.
